# PMOVES.AI Integration Guide for MAI Interface

## Integration Complete

The PMOVES.AI integration template has been applied to MAI Interface.
...
```bash
# Test health check
curl http://localhost:3738/healthz

# Verify environment variables loaded
docker compose exec mai-ui env | grep PMOVES
...
- **Tier:** ui
- **Port:** 3738
- **Health Check:** http://localhost:3738/healthz
- **NATS Enabled:** True
- **GPU Enabled:** False
